...
export const Menu = () => {
    ...
    <div className="grid grid-cols-2 justify-items-center sm:grid-cols-3 xl:grid-cols-4  py-5 px-5 gap-6 h-[500px] overflow-y-auto [scrollbar-gutter:stable]">

        {productos.map((producto) => (

            <div
                key={producto.id}
                className="bg-white w-full max-w-[220px] rounded-2xl shadow-[0_4px_15px_rgba(0,0,0,0.08)] hover:shadow-[0_6px_25px_rgba(0,0,0,0.12)] transition-all duration-300 self-start"
            >
                ...
                <div className="flex flex-col items-start p-3">
                    ...
                    <button className="flex flex-col 2xl:flex-row items-center w-full gap-2 text-[var(--second-color)] border border-[var(--second-color)] justify-center rounded-lg text-sm py-2 hover:bg-[var(--second-color)] hover:text-white transition">
